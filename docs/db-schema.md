...
6. [reservations](#7-reservations)
7. [reservation_histories](#8-reservation_histories)
8. [관계 요약](#관계-요약)
9. [설계 주요 결정 사항](#설계-주요-결정-사항)
...
| `adult_count` | INT | NOT NULL, DEFAULT 1 CHECK | 어른 수 |
| `child_count` | INT | NOT NULL, DEFAULT 0 CHECK | 아이 수 |
